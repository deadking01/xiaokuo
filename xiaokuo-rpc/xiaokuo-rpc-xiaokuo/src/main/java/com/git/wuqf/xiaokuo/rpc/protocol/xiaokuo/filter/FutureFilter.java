 ...
 */
package com.git.wuqf.xiaokuo.rpc.protocol.xiaokuo.filter;
...
import com.git.wuqf.xiaokuo.remoting.exchange.ResponseCallback;
import com.git.wuqf.xiaokuo.remoting.exchange.ResponseFuture;
import com.git.wuqf.xiaokuo.rpc.*;
import com.git.wuqf.xiaokuo.rpc.protocol.xiaokuo.FutureAdapter;
import com.git.wuqf.xiaokuo.rpc.protocol.xiaokuo.StaticContext;
        ...
        if (f instanceof FutureAdapter) {
            ...
            future.setCallback(new ResponseCallback() {
                public void done(Object rpcResult) {
                    if (rpcResult == null) {
                        logger.error("invalid result value : null, expected " + Result.class.getName());
                        return;
                    }
                    ///must be rpcResult
                    if (!(rpcResult instanceof Result)) {
                        logger.error("invalid result type :" + rpcResult.getClass() + ", expected " + Result.class.getName());
                        return;
                    }
