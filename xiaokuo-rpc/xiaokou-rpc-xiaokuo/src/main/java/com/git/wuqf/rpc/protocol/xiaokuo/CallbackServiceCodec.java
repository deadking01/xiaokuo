...
class CallbackServiceCodec {
    ...
    private static final XiaokuoProtocol protocol = XiaokuoProtocol.getXiaokuoProtocol();
    ...
    private static String exportOrunexportCallbackService(Channel channel, URL url, Class clazz, Object inst, Boolean export) throws IOException, RemotingException {
        ...
        URL exporturl = new URL(XiaokuoProtocol.NAME, channel.getLocalAddress().getAddress().getHostAddress(), channel.getLocalAddress().getPort(), clazz.getName() + "." + instid, tmpmap);
    ...
    public static Object decodeInvocationArgument(Channel channel, RpcInvocation inv, Class<?>[] pts, int paraIndex, Object inObject) throws IOException {
        ...
        URL url = null;
        try {
            url = XiaokuoProtocol.getXiaokuoProtocol().getInvoker(channel, inv).getUrl();
